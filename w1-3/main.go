...
func (a *app) complete(w http.ResponseWriter, r *http.Request) {
	...
	req := buildCompletionRequest(body.Prompt, body.System, body.Params)
...
func buildCompletionRequest(prompt, system string, overrides map[string]any) map[string]any {
	messages := []chatMessage{{Role: "user", Content: prompt}}
	if s := strings.TrimSpace(system); s != "" {
		messages = append([]chatMessage{{Role: "system", Content: s}}, messages...)
	}
